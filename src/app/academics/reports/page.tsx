...
const ReportsPage = () => {
  ...
  function CommentsSection({ student, division }: { student: any, division: string }) {
                  ...
                  <div key={student.student_id} style={styles.reportPage}>
                    ...
                    <div style={styles.header}>
                      ...
                      <div className="text-right font-bold text-xl rtl:text-right ltr:text-left" style={{ direction: 'rtl', textAlign: 'right', flex: 1 }}>
                        ...
                        <p className="arabic-font">{/* display center/no using Arabic digits */}{toArabicDigits(schoolInfo.arabic_contact)}</p>
                    ...
                    <table style={styles.studentTable}>
                      ...
                      <tbody>
                        {groupedResults.map((r: any, i: number) => {
                          ...
                          const currentInitials = teacherInitials[initialsKey] || r.teacher_name?.split(' ').map((n: string) => n[0]).join('') || 'N/A';
                    ...
                    <div style={styles.comments}>
                      <CommentsSection student={student} division={division} />
                    </div>
                    {/* Grade Table */}
                    <GradeTable />
                  </div>
        ...
        <style jsx global>{`
         html, body {
          ...
          @media print {
            ...
            /* Reset margins and padding for the body and html */
            html, body {
              margin: 0 !important;
              padding: 0 !important;
              height: auto !important;
            ...
            /* Remove padding and margin from all containers */
            .px-4, .mt-0, .p-4 {
              padding: 0 !important;
              margin: 0 !important;
            }
            ...
            /* Ensure reports fit within the page and start from top */
            .reportPage {
            ...
            /* Special handling for the first report to start at top */
            .reportPage:first-of-type {
              margin-top: 0 !important;
              padding-top: 0 !important;
            }

            /* Prevent class headings from causing page breaks */
            .classHeading {
            ...
            /* Hide customization modal if open */
            .fixed {
              display: none !important;
            }

            /* Remove any potential top spacing from the container div */
            body > div {
              margin-top: 0 !important;
              padding-top: 0 !important;
            }
