          ...
          <div>
            ...
            {students.length > 0 && (
              <div className="flex items-center gap-4 mt-3 text-sm">
                ...
                <span className="text-purple-600">Completed Portions: <span className="font-semibold">{students.reduce((sum, s) => sum + (Number(s.completed_portions) || 0), 0)}</span></span>
              </div>
            )}
          </div>
              ...
              >
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2 text-xs text-slate-600">
                    ...
                    {student.avg_marks !== null && student.avg_marks !== undefined && (
                      <div className="flex items-center justify-between">
                        <span>Avg. Mark:</span>
                        <span className="font-medium">{(typeof student.avg_marks === 'number' ? student.avg_marks : parseFloat(student.avg_marks) || 0).toFixed(1)}%</span>
                      </div>
                    )}
